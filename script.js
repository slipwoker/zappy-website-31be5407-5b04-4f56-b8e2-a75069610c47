        ...
        contactForm.addEventListener('submit', async function(e) { 
            ...
            if (!window.zappyContactFormLoaded) {
                ...
                try {
                    ...
                    const zappyPayload = {
                        websiteId: '31be5407-5b04-4f56-b8e2-a75069610c47',
                        name: formDataObject.name || formDataObject.fullName || formDataObject.firstName || '',
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ד״ר אביב גור משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
